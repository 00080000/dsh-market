window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".aqZD2G_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.aqZD2G_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.aqZD2G_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.aqZD2G_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.aqZD2G_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.aqZD2G_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.aqZD2G_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.aqZD2G_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.aqZD2G_tab.aqZD2G_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.aqZD2G_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.aqZD2G_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.aqZD2G_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.aqZD2G_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.aqZD2G_body{flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.aqZD2G_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.aqZD2G_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.aqZD2G_cats{margin:0 -4px 2px;padding:12px 4px 4px}.aqZD2G_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.aqZD2G_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.aqZD2G_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.aqZD2G_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.aqZD2G_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.aqZD2G_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.aqZD2G_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.aqZD2G_catsCollapsed{max-height:62px;overflow:hidden}.aqZD2G_catsToggle.aqZD2G_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.aqZD2G_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.aqZD2G_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.aqZD2G_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.aqZD2G_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.aqZD2G_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.aqZD2G_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.aqZD2G_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.aqZD2G_lightboxClose:hover{background:#ffffff38}.aqZD2G_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.aqZD2G_lightboxNav:hover{background:#ffffff38}.aqZD2G_lightboxPrev{left:16px}.aqZD2G_lightboxNext{right:16px}.aqZD2G_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.aqZD2G_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.aqZD2G_lightboxDotOn{background:#fff}.aqZD2G_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.aqZD2G_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.aqZD2G_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.aqZD2G_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.aqZD2G_masonry{align-items:flex-start;gap:10px;display:flex}.aqZD2G_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.aqZD2G_masonry>.aqZD2G_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.aqZD2G_masonry{flex-direction:column}.aqZD2G_masonryCol{width:100%}.aqZD2G_grid{grid-template-columns:minmax(0,1fr)}}.aqZD2G_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.aqZD2G_themesGrid{margin-bottom:12px}.aqZD2G_swatches i{flex:1}.aqZD2G_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.aqZD2G_themeSearch{width:100%;min-width:0}.aqZD2G_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.aqZD2G_themeFullscreenBtn.aqZD2G_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.aqZD2G_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.aqZD2G_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.aqZD2G_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.aqZD2G_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.aqZD2G_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.aqZD2G_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.aqZD2G_themeCover:hover img{transform:scale(1.012)}.aqZD2G_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.aqZD2G_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.aqZD2G_themePreviewAction,.aqZD2G_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.aqZD2G_themePreviewAction{gap:4px;right:8px}.aqZD2G_themePreviewCount{left:8px}.aqZD2G_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.aqZD2G_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.aqZD2G_themeIdentity{flex:1;min-width:0}.aqZD2G_themeStatus,.aqZD2G_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.aqZD2G_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.aqZD2G_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.aqZD2G_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.aqZD2G_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.aqZD2G_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.aqZD2G_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.aqZD2G_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.aqZD2G_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.aqZD2G_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.aqZD2G_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.aqZD2G_sub>span:first-child{grid-area:1/1}.aqZD2G_sub>.aqZD2G_grow{display:none}.aqZD2G_submitLink{grid-area:2/1}.aqZD2G_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.aqZD2G_themeToolbar{grid-template-columns:minmax(0,1fr)}.aqZD2G_themeCardHead{flex-wrap:wrap}.aqZD2G_themeStatus,.aqZD2G_themeStatusMuted{order:3}}@container (width<=280px){.aqZD2G_themeCardFooter{flex-direction:column;align-items:flex-start}.aqZD2G_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.aqZD2G_themeCard,.aqZD2G_themeCover img{transition:none}.aqZD2G_themeCard:hover{transform:none}}.aqZD2G_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.aqZD2G_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.aqZD2G_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.aqZD2G_installBtn.aqZD2G_installBtn{min-width:64px}.aqZD2G_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.aqZD2G_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.aqZD2G_nmLink{color:inherit;text-decoration:none;display:block}.aqZD2G_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.aqZD2G_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.aqZD2G_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.aqZD2G_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.aqZD2G_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.aqZD2G_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.aqZD2G_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.aqZD2G_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.aqZD2G_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.aqZD2G_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.aqZD2G_foot .aqZD2G_metaInline,.aqZD2G_foot .aqZD2G_src{white-space:nowrap}.aqZD2G_grow{flex:1}.aqZD2G_titleRow{align-items:center;gap:10px;display:flex}.aqZD2G_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.aqZD2G_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.aqZD2G_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.aqZD2G_descTight{min-height:0}.aqZD2G_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.aqZD2G_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.aqZD2G_dot{vertical-align:2px;margin-left:5px}.aqZD2G_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.aqZD2G_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.aqZD2G_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.aqZD2G_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.aqZD2G_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.aqZD2G_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.aqZD2G_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite aqZD2G_sp;display:inline-flex}.aqZD2G_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.aqZD2G_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite aqZD2G_dshmPlug}@keyframes aqZD2G_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.aqZD2G_logoPlug,.aqZD2G_spin{animation:1.5s ease-in-out infinite aqZD2G_dshmPlugFade}}@keyframes aqZD2G_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes aqZD2G_sp{to{transform:rotate(360deg)}}.aqZD2G_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.aqZD2G_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.aqZD2G_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.aqZD2G_barWave{width:30%;animation:1.2s ease-in-out infinite aqZD2G_dshmSlide}@keyframes aqZD2G_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.aqZD2G_irow .aqZD2G_progress{margin-top:8px}.aqZD2G_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.aqZD2G_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.aqZD2G_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.aqZD2G_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.aqZD2G_conflictHead{align-items:flex-start;gap:8px;display:flex}.aqZD2G_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.aqZD2G_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.aqZD2G_conflictBody{margin:0;font-size:12px;line-height:19px}.aqZD2G_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.aqZD2G_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.aqZD2G_rosterMain{flex-direction:column;min-width:0;display:flex}.aqZD2G_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.aqZD2G_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.aqZD2G_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.aqZD2G_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.aqZD2G_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.aqZD2G_rosterRowOut .aqZD2G_rosterName{text-decoration:line-through}.aqZD2G_rosterRowOut{opacity:.62}.aqZD2G_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.aqZD2G_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.aqZD2G_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.aqZD2G_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.aqZD2G_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.aqZD2G_choices{flex-direction:column;gap:7px;display:flex}.aqZD2G_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.aqZD2G_choice:has(input:disabled){cursor:default;opacity:.6}.aqZD2G_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.aqZD2G_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.aqZD2G_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.aqZD2G_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.aqZD2G_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.aqZD2G_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.aqZD2G_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.aqZD2G_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.aqZD2G_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.aqZD2G_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.aqZD2G_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.aqZD2G_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.aqZD2G_nameLink{color:inherit;text-decoration:none}.aqZD2G_irowName{text-overflow:clip;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.aqZD2G_irowNameText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.aqZD2G_irowName>.aqZD2G_owner{flex:none}.aqZD2G_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.aqZD2G_opWrap{flex-shrink:0;display:inline-flex;position:relative}.aqZD2G_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.aqZD2G_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.aqZD2G_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.aqZD2G_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.aqZD2G_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.aqZD2G_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.aqZD2G_opPanelTitle{font-size:12.5px;font-weight:600}.aqZD2G_opCloseBtn.aqZD2G_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.aqZD2G_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.aqZD2G_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.aqZD2G_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.aqZD2G_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.aqZD2G_opRow:last-child{border-bottom:none}.aqZD2G_opRowAlert{background:#dc26260f}.aqZD2G_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.aqZD2G_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.aqZD2G_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.aqZD2G_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.aqZD2G_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.aqZD2G_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.aqZD2G_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.aqZD2G_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.aqZD2G_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.aqZD2G_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.aqZD2G_opDecisionFoot{align-items:center;gap:8px;display:flex}.aqZD2G_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.aqZD2G_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.aqZD2G_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.aqZD2G_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.aqZD2G_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.aqZD2G_dangerBtn.aqZD2G_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.aqZD2G_dangerBtn.aqZD2G_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.aqZD2G_dangerArmed.aqZD2G_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.aqZD2G_retryBtn{margin-top:4px}.aqZD2G_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.aqZD2G_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.aqZD2G_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.aqZD2G_irowMissing{filter:grayscale();opacity:.5}.aqZD2G_irow>.aqZD2G_src,.aqZD2G_irow>.aqZD2G_owner,.aqZD2G_irow button{white-space:nowrap;flex-shrink:0}.aqZD2G_tabSearchRow{padding:0 4px 6px;display:flex}.aqZD2G_tabSearch{width:100%}.aqZD2G_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.aqZD2G_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.aqZD2G_specTagGit{color:#0b7285;background:#12a3c41f}.aqZD2G_specTagFile{color:#b07d1b;background:#f0b42924}.aqZD2G_backupCheckList .aqZD2G_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.aqZD2G_backupCheckList .aqZD2G_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.aqZD2G_staleAction{margin-top:8px}.aqZD2G_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.aqZD2G_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.aqZD2G_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.aqZD2G_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.aqZD2G_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.aqZD2G_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.aqZD2G_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.aqZD2G_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.aqZD2G_deprecate .aqZD2G_src{margin-left:8px}.aqZD2G_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.aqZD2G_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.aqZD2G_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.aqZD2G_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.aqZD2G_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.aqZD2G_switchOn .aqZD2G_switchKnob,.aqZD2G_switchMixed .aqZD2G_switchKnob{left:18px}.aqZD2G_switch:disabled{opacity:.5;cursor:default}.aqZD2G_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.aqZD2G_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.aqZD2G_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.aqZD2G_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.aqZD2G_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.aqZD2G_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.aqZD2G_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.aqZD2G_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.aqZD2G_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.aqZD2G_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.aqZD2G_groupMember .aqZD2G_nm{flex:1;min-width:0;font-size:12px}.aqZD2G_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.aqZD2G_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.aqZD2G_inlineInput{flex:1;min-width:120px}.aqZD2G_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.aqZD2G_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.aqZD2G_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.aqZD2G_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.aqZD2G_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.aqZD2G_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.aqZD2G_backupCard h3{margin:0;font-size:14px}.aqZD2G_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.aqZD2G_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.aqZD2G_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.aqZD2G_backupInput{box-sizing:border-box;width:100%}.aqZD2G_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.aqZD2G_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.aqZD2G_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.aqZD2G_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.aqZD2G_backupCheckList .aqZD2G_backupCheck{justify-content:space-between;gap:8px}.aqZD2G_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.aqZD2G_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.aqZD2G_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.aqZD2G_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.aqZD2G_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.aqZD2G_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.aqZD2G_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.aqZD2G_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.aqZD2G_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.aqZD2G_diagBundle:first-of-type{border-top:none;padding-top:0}.aqZD2G_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.aqZD2G_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.aqZD2G_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.aqZD2G_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.aqZD2G_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.aqZD2G_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.aqZD2G_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.aqZD2G_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.aqZD2G_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.aqZD2G_diagList{flex-direction:column;gap:6px;display:flex}.aqZD2G_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.aqZD2G_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.aqZD2G_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.aqZD2G_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.aqZD2G_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.aqZD2G_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.aqZD2G_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.aqZD2G_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.aqZD2G_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.aqZD2G_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.aqZD2G_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.aqZD2G_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.aqZD2G_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.aqZD2G_collapseTitle{flex:1;min-width:0}.aqZD2G_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.aqZD2G_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.aqZD2G_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.aqZD2G_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.aqZD2G_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.aqZD2G_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.aqZD2G_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.aqZD2G_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.aqZD2G_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.aqZD2G_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.aqZD2G_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.aqZD2G_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.aqZD2G_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.aqZD2G_setChevronOpen{transform:rotate(180deg)}.aqZD2G_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.aqZD2G_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.aqZD2G_setRow+.aqZD2G_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.aqZD2G_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.aqZD2G_setLabel{font-size:13px;line-height:20px}.aqZD2G_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.aqZD2G_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.aqZD2G_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.aqZD2G_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.aqZD2G_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.aqZD2G_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.aqZD2G_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.aqZD2G_setSegBtn:disabled{cursor:default;opacity:.5}.aqZD2G_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.aqZD2G_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}";
		...
		var Market_module_css_default = {
			"act": "aqZD2G_act",
			"actBroken": "aqZD2G_actBroken",
			"actLive": "aqZD2G_actLive",
			"actWarn": "aqZD2G_actWarn",
			"actWhy": "aqZD2G_actWhy",
			"assignRow": "aqZD2G_assignRow",
			"assignSelect": "aqZD2G_assignSelect",
			"av": "aqZD2G_av",
			"backupActions": "aqZD2G_backupActions",
			"backupCard": "aqZD2G_backupCard",
			"backupCheck": "aqZD2G_backupCheck",
			"backupCheckList": "aqZD2G_backupCheckList",
			"backupGrid": "aqZD2G_backupGrid",
			"backupInput": "aqZD2G_backupInput",
			"backupMessage": "aqZD2G_backupMessage",
			"backupWarn": "aqZD2G_backupWarn",
			"banner": "aqZD2G_banner",
			"bannerHint": "aqZD2G_bannerHint",
			"bannerIcon": "aqZD2G_bannerIcon",
			"bar": "aqZD2G_bar",
			"barFill": "aqZD2G_barFill",
			"barWave": "aqZD2G_barWave",
			"body": "aqZD2G_body",
			"byline": "aqZD2G_byline",
			"card": "aqZD2G_card",
			"cardAction": "aqZD2G_cardAction",
			"cardBlocked": "aqZD2G_cardBlocked",
			"cardBlockedMark": "aqZD2G_cardBlockedMark",
			"cardShot": "aqZD2G_cardShot",
			"cardShots": "aqZD2G_cardShots",
			"cats": "aqZD2G_cats",
			"catsCollapsed": "aqZD2G_catsCollapsed",
			"catsRow": "aqZD2G_catsRow",
			"catsToggle": "aqZD2G_catsToggle",
			"catsWrap": "aqZD2G_catsWrap",
			"choice": "aqZD2G_choice",
			"choiceMain": "aqZD2G_choiceMain",
			"choiceNote": "aqZD2G_choiceNote",
			"choiceOn": "aqZD2G_choiceOn",
			"choiceRadio": "aqZD2G_choiceRadio",
			"choices": "aqZD2G_choices",
			"choiceSafe": "aqZD2G_choiceSafe",
			"choiceTitle": "aqZD2G_choiceTitle",
			"cmd": "aqZD2G_cmd",
			"collapseBody": "aqZD2G_collapseBody",
			"collapseHead": "aqZD2G_collapseHead",
			"collapseIcon": "aqZD2G_collapseIcon",
			"collapseTitle": "aqZD2G_collapseTitle",
			"conflictBody": "aqZD2G_conflictBody",
			"conflictDetailsToggle": "aqZD2G_conflictDetailsToggle",
			"conflictHead": "aqZD2G_conflictHead",
			"conflictIcon": "aqZD2G_conflictIcon",
			"conflictTitle": "aqZD2G_conflictTitle",
			"conflictWhy": "aqZD2G_conflictWhy",
			"conflictWhyText": "aqZD2G_conflictWhyText",
			"dangerArmed": "aqZD2G_dangerArmed",
			"dangerBtn": "aqZD2G_dangerBtn",
			"depBadge": "aqZD2G_depBadge",
			"depLine": "aqZD2G_depLine",
			"deprecate": "aqZD2G_deprecate",
			"desc": "aqZD2G_desc",
			"descClamp": "aqZD2G_descClamp",
			"descTight": "aqZD2G_descTight",
			"descToggle": "aqZD2G_descToggle",
			"diagAlert": "aqZD2G_diagAlert",
			"diagArrow": "aqZD2G_diagArrow",
			"diagBadgeCommunity": "aqZD2G_diagBadgeCommunity",
			"diagBadgeOfficial": "aqZD2G_diagBadgeOfficial",
			"diagBadgeShadow": "aqZD2G_diagBadgeShadow",
			"diagBundle": "aqZD2G_diagBundle",
			"diagCount": "aqZD2G_diagCount",
			"diagEmpty": "aqZD2G_diagEmpty",
			"diagIndex": "aqZD2G_diagIndex",
			"diagKey": "aqZD2G_diagKey",
			"diagList": "aqZD2G_diagList",
			"diagMeta": "aqZD2G_diagMeta",
			"diagPage": "aqZD2G_diagPage",
			"diagRow": "aqZD2G_diagRow",
			"diagSection": "aqZD2G_diagSection",
			"diagSummary": "aqZD2G_diagSummary",
			"diagSummaryItem": "aqZD2G_diagSummaryItem",
			"diagSummaryMeta": "aqZD2G_diagSummaryMeta",
			"diagVal": "aqZD2G_diagVal",
			"dot": "aqZD2G_dot",
			"dragging": "aqZD2G_dragging",
			"dragHandle": "aqZD2G_dragHandle",
			"dragOver": "aqZD2G_dragOver",
			"dshmPlug": "aqZD2G_dshmPlug",
			"dshmPlugFade": "aqZD2G_dshmPlugFade",
			"dshmSlide": "aqZD2G_dshmSlide",
			"empty": "aqZD2G_empty",
			"err": "aqZD2G_err",
			"exportLogBtn": "aqZD2G_exportLogBtn",
			"fixFallback": "aqZD2G_fixFallback",
			"fixFallbackText": "aqZD2G_fixFallbackText",
			"foot": "aqZD2G_foot",
			"grid": "aqZD2G_grid",
			"groupActions": "aqZD2G_groupActions",
			"groupAddPanel": "aqZD2G_groupAddPanel",
			"groupCreate": "aqZD2G_groupCreate",
			"groupHead": "aqZD2G_groupHead",
			"groupHint": "aqZD2G_groupHint",
			"groupMember": "aqZD2G_groupMember",
			"groupMembers": "aqZD2G_groupMembers",
			"groupName": "aqZD2G_groupName",
			"groupRow": "aqZD2G_groupRow",
			"grow": "aqZD2G_grow",
			"head": "aqZD2G_head",
			"hiddenFile": "aqZD2G_hiddenFile",
			"inlineInput": "aqZD2G_inlineInput",
			"installBtn": "aqZD2G_installBtn",
			"irow": "aqZD2G_irow",
			"irowActions": "aqZD2G_irowActions",
			"irowMissing": "aqZD2G_irowMissing",
			"irowName": "aqZD2G_irowName",
			"irowNameText": "aqZD2G_irowNameText",
			"irowTrailing": "aqZD2G_irowTrailing",
			"lightbox": "aqZD2G_lightbox",
			"lightboxClose": "aqZD2G_lightboxClose",
			"lightboxDot": "aqZD2G_lightboxDot",
			"lightboxDotOn": "aqZD2G_lightboxDotOn",
			"lightboxDots": "aqZD2G_lightboxDots",
			"lightboxImg": "aqZD2G_lightboxImg",
			"lightboxNav": "aqZD2G_lightboxNav",
			"lightboxNext": "aqZD2G_lightboxNext",
			"lightboxPrev": "aqZD2G_lightboxPrev",
			"loading": "aqZD2G_loading",
			"logoMark": "aqZD2G_logoMark",
			"logoPlug": "aqZD2G_logoPlug",
			"masonry": "aqZD2G_masonry",
			"masonryCol": "aqZD2G_masonryCol",
			"meta": "aqZD2G_meta",
			"metaInline": "aqZD2G_metaInline",
			"metaTag": "aqZD2G_metaTag",
			"metaTagOk": "aqZD2G_metaTagOk",
			"modalNote": "aqZD2G_modalNote",
			"nameLink": "aqZD2G_nameLink",
			"nm": "aqZD2G_nm",
			"nmLink": "aqZD2G_nmLink",
			"okState": "aqZD2G_okState",
			"on": "aqZD2G_on",
			"opActions": "aqZD2G_opActions",
			"opAggregate": "aqZD2G_opAggregate",
			"opAggregateHint": "aqZD2G_opAggregateHint",
			"opAggregateTop": "aqZD2G_opAggregateTop",
			"opCloseBtn": "aqZD2G_opCloseBtn",
			"opDecision": "aqZD2G_opDecision",
			"opDecisionFoot": "aqZD2G_opDecisionFoot",
			"opDot": "aqZD2G_opDot",
			"opEmpty": "aqZD2G_opEmpty",
			"opEmptyHint": "aqZD2G_opEmptyHint",
			"opEntry": "aqZD2G_opEntry",
			"opEntryAlert": "aqZD2G_opEntryAlert",
			"opEntryQuiet": "aqZD2G_opEntryQuiet",
			"opHead": "aqZD2G_opHead",
			"opIcon": "aqZD2G_opIcon",
			"opMain": "aqZD2G_opMain",
			"opName": "aqZD2G_opName",
			"opPanel": "aqZD2G_opPanel",
			"opPanelTitle": "aqZD2G_opPanelTitle",
			"opQueuedIcon": "aqZD2G_opQueuedIcon",
			"opRow": "aqZD2G_opRow",
			"opRowAlert": "aqZD2G_opRowAlert",
			"opStatus": "aqZD2G_opStatus",
			"opStatusBad": "aqZD2G_opStatusBad",
			"opTop": "aqZD2G_opTop",
			"opVerb": "aqZD2G_opVerb",
			"opWrap": "aqZD2G_opWrap",
			"orphBadge": "aqZD2G_orphBadge",
			"orphRow": "aqZD2G_orphRow",
			"ovArrow": "aqZD2G_ovArrow",
			"ovByTag": "aqZD2G_ovByTag",
			"ovFrom": "aqZD2G_ovFrom",
			"ovRow": "aqZD2G_ovRow",
			"owner": "aqZD2G_owner",
			"pageEllipsis": "aqZD2G_pageEllipsis",
			"pageInfo": "aqZD2G_pageInfo",
			"pager": "aqZD2G_pager",
			"pagerPages": "aqZD2G_pagerPages",
			"panelNote": "aqZD2G_panelNote",
			"pct": "aqZD2G_pct",
			"progress": "aqZD2G_progress",
			"reassure": "aqZD2G_reassure",
			"reassureOk": "aqZD2G_reassureOk",
			"repoLink": "aqZD2G_repoLink",
			"retryBtn": "aqZD2G_retryBtn",
			"root": "aqZD2G_root",
			"roster": "aqZD2G_roster",
			"rosterAuthor": "aqZD2G_rosterAuthor",
			"rosterMain": "aqZD2G_rosterMain",
			"rosterName": "aqZD2G_rosterName",
			"rosterRow": "aqZD2G_rosterRow",
			"rosterRowOut": "aqZD2G_rosterRowOut",
			"rosterSplit": "aqZD2G_rosterSplit",
			"rosterTag": "aqZD2G_rosterTag",
			"rosterTagDrop": "aqZD2G_rosterTagDrop",
			"rosterTagKeep": "aqZD2G_rosterTagKeep",
			"row1": "aqZD2G_row1",
			"sectAction": "aqZD2G_sectAction",
			"sectionOverview": "aqZD2G_sectionOverview",
			"setActions": "aqZD2G_setActions",
			"setBetaTag": "aqZD2G_setBetaTag",
			"setBody": "aqZD2G_setBody",
			"setCard": "aqZD2G_setCard",
			"setCardOpen": "aqZD2G_setCardOpen",
			"setCheck": "aqZD2G_setCheck",
			"setChevron": "aqZD2G_setChevron",
			"setChevronOpen": "aqZD2G_setChevronOpen",
			"setConfirm": "aqZD2G_setConfirm",
			"setDanger": "aqZD2G_setDanger",
			"setDesc": "aqZD2G_setDesc",
			"setHeader": "aqZD2G_setHeader",
			"setHeadText": "aqZD2G_setHeadText",
			"setHint": "aqZD2G_setHint",
			"setLabel": "aqZD2G_setLabel",
			"setLabelBox": "aqZD2G_setLabelBox",
			"setName": "aqZD2G_setName",
			"setRow": "aqZD2G_setRow",
			"setSeg": "aqZD2G_setSeg",
			"setSegBtn": "aqZD2G_setSegBtn",
			"setSegOn": "aqZD2G_setSegOn",
			"shot": "aqZD2G_shot",
			"shots": "aqZD2G_shots",
			"sp": "aqZD2G_sp",
			"spec": "aqZD2G_spec",
			"specTag": "aqZD2G_specTag",
			"specTagFile": "aqZD2G_specTagFile",
			"specTagGit": "aqZD2G_specTagGit",
			"spin": "aqZD2G_spin",
			"src": "aqZD2G_src",
			"staleAction": "aqZD2G_staleAction",
			"star": "aqZD2G_star",
			"stateDot": "aqZD2G_stateDot",
			"stateTag": "aqZD2G_stateTag",
			"stickyHead": "aqZD2G_stickyHead",
			"sub": "aqZD2G_sub",
			"submitLink": "aqZD2G_submitLink",
			"subTabs": "aqZD2G_subTabs",
			"swatches": "aqZD2G_swatches",
			"switch": "aqZD2G_switch",
			"switchKnob": "aqZD2G_switchKnob",
			"switchMixed": "aqZD2G_switchMixed",
			"switchOn": "aqZD2G_switchOn",
			"tab": "aqZD2G_tab",
			"tabs": "aqZD2G_tabs",
			"tabSearch": "aqZD2G_tabSearch",
			"tabSearchRow": "aqZD2G_tabSearchRow",
			"tag": "aqZD2G_tag",
			"themeActions": "aqZD2G_themeActions",
			"themeCard": "aqZD2G_themeCard",
			"themeCardBody": "aqZD2G_themeCardBody",
			"themeCardFooter": "aqZD2G_themeCardFooter",
			"themeCardHead": "aqZD2G_themeCardHead",
			"themeCover": "aqZD2G_themeCover",
			"themeCoverEmpty": "aqZD2G_themeCoverEmpty",
			"themeDescription": "aqZD2G_themeDescription",
			"themeFullscreenBtn": "aqZD2G_themeFullscreenBtn",
			"themeGallery": "aqZD2G_themeGallery",
			"themeIdentity": "aqZD2G_themeIdentity",
			"themeLifecycle": "aqZD2G_themeLifecycle",
			"themePreviewAction": "aqZD2G_themePreviewAction",
			"themePreviewCount": "aqZD2G_themePreviewCount",
			"themeResultBar": "aqZD2G_themeResultBar",
			"themeSearch": "aqZD2G_themeSearch",
			"themesGrid": "aqZD2G_themesGrid",
			"themeStatus": "aqZD2G_themeStatus",
			"themeStatusMuted": "aqZD2G_themeStatusMuted",
			"themeToolbar": "aqZD2G_themeToolbar",
			"themeToolbarActions": "aqZD2G_themeToolbarActions",
			"title": "aqZD2G_title",
			"titleRow": "aqZD2G_titleRow",
			"top": "aqZD2G_top",
			"topBtn": "aqZD2G_topBtn",
			"version": "aqZD2G_version",
			"viewBar": "aqZD2G_viewBar",
			"viewBtn": "aqZD2G_viewBtn",
			"viewOn": "aqZD2G_viewOn",
			"warnLine": "aqZD2G_warnLine"
		};
		//#endregion
